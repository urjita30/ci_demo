		...
		<div class="page-content">
			...
			<div class="content-wrapper">
				...
				<div class="content pb-20">
					...
					<form action="<?php echo site_url('admin'); ?>" class="form-validate" method="post" id="login_form">
						<div class="panel panel-body login-form">
							...
							<a href="<?php echo site_url('admin/register') ?>" class="btn btn-default btn-block content-group">Sign up</a>
	...
	<script>
		$().ready(function(){
			$('#login_form').validate({
				...
				messages: {
					txt_username: "Please enter a username",
					txt_password: "Please provide a password",
				}
			});
		});
	</script>
